export const CLI_COMMANDS = [
  ...
  "card:evaluate-triggers --feed <id> [--now <ISO timestamp>]",
  ...
  "work:executor-reserve --feed <id> --work <id> --token <token> --repo <key> --resource <key> --source-fingerprint <digest>",
  "work:executor-bind --feed <id> --work <id> --token <token> --task <Codex task id> --project <Codex project id> --cwd <absolute repo root>",
  "work:executor-claim --feed <id> --work <id> --task <Codex task id>",
  ...
  "work:block --feed <id> --work <id> --token <token> ((--result <json> | --result-file <path>) | --error <text> [--owner <text>] [--unblock-action <text>])",
